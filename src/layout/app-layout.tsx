...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Result', path: '/results', entity: 'result', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
    { name: 'Test', path: '/tests', entity: 'test', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
